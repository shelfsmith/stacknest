        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 22) {
                ...
                section("表紙を変える") {
                    ...
                    bullet("シーンから表紙を選択… — mp4 / mov / m4v で、シークバー付きのプレイヤーから表紙にする場面を選ぶ。続けてその場面をクロップすることもでき、クロップせずに決定することもできます。選んだ場面は記録されるので、「表紙を再生成」で**同じ場面**を作り直せます（ローカルの本のみ。リモートでは選べません）")
