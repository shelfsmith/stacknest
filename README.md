...
- **対応形式**: アーカイブは ZIP / CBZ / RAR / CBR / 7z（libarchive 経由）と PDF（PDFKit）、EPUB（**ベータ**。表紙・メタデータ・閲覧。Mac では [Washi](https://github.com/shunnag/Washi) の窓で縦組み・ルビ・見開き、Web リーダーでは [foliate-js](https://github.com/johnfactotum/foliate-js)。全ページ画像の EPUB は画像ビューアで開く）、画像は JPEG / PNG / GIF / WebP / HEIC / HEIF / TIFF / AVIF（NSImage 経由）
