...
- **Supported formats**: archives ZIP / CBZ / RAR / CBR / 7z (via libarchive), PDF (PDFKit), and EPUB (**beta**: cover, metadata and reading — on the Mac in a [Washi](https://github.com/shunnag/Washi) window with vertical text, ruby and spreads; in the web reader through [foliate-js](https://github.com/johnfactotum/foliate-js); all-image EPUBs open in the image viewer); images JPEG / PNG / GIF / WebP / HEIC / HEIF / TIFF / AVIF (via NSImage)
